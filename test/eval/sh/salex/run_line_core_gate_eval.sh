...
LINE_CORE_GATE_MODES="${LINE_CORE_GATE_MODES:-line_edge_core_gate_mlp_w8a32 line_node_core_gate_mlp_w8a32 line_nonlinear_core_gate_mlp_w8a32}"
...
for mode in ${LINE_CORE_GATE_MODES}; do
  echo
  echo "=== Running line graph core+gate static eval: ${mode} ==="
