...
ATOM_NONLINEAR_SPLIT_MODES="${ATOM_NONLINEAR_SPLIT_MODES:-atom_attn_edge_mlp_w8a32 atom_refine_edge_mlp_w8a32 atom_attn_node_mlp_w8a32}"
...
for mode in ${ATOM_NONLINEAR_SPLIT_MODES}; do
  echo
  echo "=== Running atom nonlinear split static eval: ${mode} ==="
